...
public class Borrow implements Serializable, DataRow {
    private String id;
    ...
    public Borrow(String id, String assetId, String employeeId, int quantity, LocalDateTime time) {
        this.id = id;
    ...
    public String toString() {
        return "Borrow{" + "id='" + id + '\'' + ", assetId='" + assetId + '\'' + ", " +
